...
FDShort.propTypes = {
  ...
  [APPLICANT_CONTACT_EMAIL_1.id]: PropTypes.string.isRequired,
  ...
  [APPLICANT_CONTACT_EMAIL_1.func]: PropTypes.func.isRequired,
  ...
  [APPLICANT_PII_SOCIAL.func]: PropTypes.func.isRequired,
  [APPLICANT_PII_DOB.func]: PropTypes.func.isRequired,
...
const mapStateToProps = (state) => {
  return {
    ...
    [APPLICANT_CONTACT_EMAIL_1.id]: state.applicant.contact.email,
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    [APPLICANT_CONTACT_EMAIL_1.func]: (contactEmail) => { dispatch(setApplicantContact({ email: contactEmail })); },
